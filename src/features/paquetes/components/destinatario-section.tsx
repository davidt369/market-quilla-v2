            ...
            <div className="mb-4">
                ...
                <div className="relative mt-1.5">
                    <ClientCombobox
                        ...
                        onChange={(val) => handleClientSelected("destinatario", val)}
                ...
                <Controller
                    ...
                    render={({ field, fieldState }) => (
                        <Field data-invalid={fieldState.invalid}>
                            ...
                            <Input {...field} id={field.name} placeholder="Ej: María López" />
                ...
                <Controller
                    ...
                    render={({ field, fieldState }) => (
                        <Field data-invalid={fieldState.invalid}>
                            ...
                            <Input {...field} id={field.name} placeholder="Ej: 98765432" />
                            {fieldState.invalid && <FieldError errors={[fieldState.error]} />}
                        </Field>
                    )}
                />
                <Controller
                    ...
                    render={({ field, fieldState }) => (
                        <Field data-invalid={fieldState.invalid} className="sm:col-span-2">
                            ...
                            <Input {...field} id={field.name} placeholder="Ej: TechCorp S.R.L." />
                            {fieldState.invalid && <FieldError errors={[fieldState.error]} />}
                        </Field>
                    )}
                />
